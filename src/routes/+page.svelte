...
<div class="flex">
  <header class="md:w-1/2 xl:w-1/3 h-screen flex flex-col">
    ...
    <p class="w-full text-center text-slate-600 uppercase pt-80 roboto-mono">Michael Dykema</p>
  ...
  <main class="w-2/3 pr-16">
    <nav>
      <ul class="flex justify-around mt-16">
        <li>
